...
export const EXORCISM_BOSS_DEFINITIONS: DeclarativeBossDefinition[] = [
  ...
  },
  {
    ...
    mechanics: [
      ...
      }),
      {
        ...
        reusable: true,
        once: true,
        triggers: [{ type: 'playerDialogue', dialogueIncludes: ['拒绝', '不是爸爸', '不需要母爱'] }],
        actions: [
          { type: 'setPhase', phase: 2 },
          { type: 'setSkillPool', skillPoolKey: 'hachishaku_true_mother' },
          logAction('玩家拒绝母爱，八尺先生提前进入真母阶段。'),
        ],
      },
      {
  ...
  },
  {
    ...
    phases: [
      ...
      { phase: 2, displayName: '狐妻觉醒', dataKey: '鬼祝男椿_二阶段', skillPoolKey: 'tsubaki_fox_wife' },
    ],
    mechanics: [
      {
    ...
    taskHooks: { questName: '驱魔', objectiveKeys: ['B3_鬼祝男椿压制'], companionNames: ['风音', '铃音'] },
  },
  {
  ...
  },
  {
    ...
    category: 'exorcism',
    status: 'draft',
    phases: [{ phase: 1, displayName: '僵尸化天羽', dataKey: '僵尸天翔', skillPoolKey: 'zombie_tianyu' }],
    mechanics: [
      manualRule({
    ...
    taskHooks: { questName: '驱魔', objectiveKeys: ['B1_僵尸天翔净化'], companionNames: ['风音'] },
  },
  {
    id: 'exorcism_chloe',
  ...
  },
  {
    ...
    phases: [
      ...
      { phase: 3, displayName: '熟女形态', dataKey: '万魔之父_三阶段', skillPoolKey: 'mother_demon_mature' },
    ],
    mechanics: [
      phaseByHp({
    ...
    taskHooks: { questName: '驱魔', objectiveKeys: ['B5_万魔之父封印'], companionNames: ['风音'] },
  },
  {
    id: 'exorcism_veil',
  ...
  },
  {
    ...
    taskHooks: { questName: '驱魔', objectiveKeys: ['B3_玉藻净化'], companionNames: ['伊丽莎白'] },
  },
];
